...
import BrowserApiKeyPanel from '../components/BrowserApiKeyPanel.jsx'
...
export default function NewAnalysis() {
  ...
  const handleSubmit = async (payload) => {
    ...
    try {
      const result = await runAnalysis(payload, { apiKey: analysisApiKey })
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
      <div>
        ...
        <div className="mt-6">
          <BrowserApiKeyPanel onApiKeyChange={handleApiKeyChange} />
        </div>
        <div className="mt-6">
